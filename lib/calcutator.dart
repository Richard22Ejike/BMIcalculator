        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const Text("We care about your health", style: TextStyle(color: Colors.grey, fontSize: 15, fontWeight: FontWeight.w400),),
              const SizedBox(
                height: 32,
              ),

              const Text("Gender", style: TextStyle(color: Colors.grey, fontSize: 24, fontWeight: FontWeight.w400),),
              ...
              const Text("Height (cm)", style: TextStyle(color: Colors.grey, fontSize: 24, fontWeight: FontWeight.w400),),
              ...
              Text("$_heightOfUser cm", style: const TextStyle(color: Colors.red, fontSize: 18, fontWeight: FontWeight.w900),),

              const SizedBox(height: 24,),

              const Text("Weight (kg)", style: TextStyle(color: Colors.grey, fontSize: 24, fontWeight: FontWeight.w400),),
              ...
              Text("$_weightOfUser kg", style: const TextStyle(color: Colors.red, fontSize: 18, fontWeight: FontWeight.w900),),
